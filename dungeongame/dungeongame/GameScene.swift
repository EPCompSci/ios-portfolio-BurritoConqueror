...
class GameScene: SKScene {
    ...
    override func didMove(to view: SKView) {
        ...
        heart1 = camera?.childNode(withName: "heart_1") as! SKSpriteNode
        heart2 = camera?.childNode(withName: "heart_1") as! SKSpriteNode
        heart3 = camera?.childNode(withName: "heart_1") as! SKSpriteNode
        for i in 0..<3 {
